...
def prep4catalyst(fdistribu_py, electrostatic_potential_py, iter_py, meshx_py, meshy_py, meshvx_py, meshvy_py, local_fdistribu_extents_py, local_fdistribu_starts_py):
    ...
    PT_X=int(local_fdistribu_extents_py[1]/2)
    PT_Y=int(local_fdistribu_extents_py[2]/2)

    fdistribu_selected=fdistribu_py[0, PT_X, PT_Y, :, :]
    time = iter_py * 0.1
    ...
    coord_Y = meshvy_py[local_fdistribu_starts_py[4]:local_fdistribu_starts_py[4]+local_fdistribu_extents_py[4]]
    ...
    pdi.multi_expose("catalyst_execute", [
                    ...
                    ("local_points_X", coord_X, pdi.OUT),
                    ("local_points_Y", coord_Y, pdi.OUT)
